Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "onePost_#{Rails.env}"
  ...
  Rails.application.routes.default_url_options[:host] = 'one1post.herokuapp.com'
